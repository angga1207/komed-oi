            ...
            <div class="card card-table">
                <div class="card-body">
                    ...
                    <form class="mb-2 d-flex align-items-center justify-content-between flex-grow-1 flex-wrap gap-1"
                        ...
                        <input type="search" class="form-control" style="max-width:49%" placeholder="Pencarian..."
                            wire:model="search" />
                                    ...
                                    <tr wire:key="{{ $data->id }}">
                                        ...
                                        <td>
                                            @if ($data->status == 'sent')
                                                ...
                                                <div x-init="startTimer('{{ Carbon::parse($data->deadline) }}', 'timer{{ $data->id }}')" id="timer{{ $data->id }}">
                                                </div>
        ...
        <script>
            function startTimer(date, elemID) {
                ...
                var x = setInterval(function() {
                    ...
                    document.getElementById(elemID).innerHTML = "<div class='countdown'>" + days +
                        " <span> hari </span> " + hours + " <span>jam</span> " + minutes + " <span>mnt </span> " +
                        seconds + "<span> dtk</span> </div>";

                    // If the count down is finished, write some text
                    if (distance < 0) {
                        clearInterval(x);
                        document.getElementById(elemID).innerHTML =
                            "<div class='countdown-end text-danger'>Sudah Lewat Batas</div>";
                    }
                }, 1000);
            }
        </script>
