    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-sm-3">
                    <div class="main-tiles border card-hover card o-hidden" wire:click="goTo('Media Cetak')">
                ...
                <div class="col-sm-3">
                    <div class="main-tiles border card-hover card o-hidden" wire:click="goTo('Media Elektronik')">
                        <div class="custome-1-bg b-r-4 card-body">
                            <div class="media align-items-center static-top-widget">
                                <div class="media-body p-0">
                                    <span
                ...
                <div class="col-sm-3">
                    <div class="main-tiles border card-hover card o-hidden" wire:click="goTo('Media Siber')">
                        <div class="custome-1-bg b-r-4 card-body">
                            <div class="media align-items-center static-top-widget">
                                <div class="media-body p-0">
                ...
                <div class="col-sm-3">
                    <div class="main-tiles border card-hover card o-hidden" wire:click="goTo('Media Sosial')">
                        <div class="custome-1-bg b-r-4 card-body">
                            <div class="media align-items-center static-top-widget">
                                <div class="media-body p-0">
                                    <span
                    ...
                    <tbody>
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td>{{ $data->Evidences->where('type', 'link')->first()->url ?? '-' }}</td>
                                <td>{{ Carbon\Carbon::parse($data->tanggal_pelaksanaan)->isoFormat('DD MMM Y') }}</td>
                                <td></td>
                                <td></td>
                                <td>{{ $data->MediaPers->alamat_media ?? '' }}</td>
                                <td>{{ $data->MediaPers->email ?? '' }}</td>
                                <td>{{ $data->MediaPers->whatsapp ?? '' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
