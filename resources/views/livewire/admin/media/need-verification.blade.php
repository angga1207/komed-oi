                                    ...
                                    @forelse($datas as $data)
                                        <tr>
                                            ...
                                            <div class="d-flex align-items-center flex-column gap-2">
                                                <div>
                                                    <span
                                                        class="badge badge-{{ $data->isFilesComplete() == true ? 'success' : 'danger' }}">
                                                        {{ $data->isFilesComplete() == true ? 'Lengkap' : 'Tidak
                                                        Lengkap' }}
                                                    </span>
                                                </div>
                                                <div>
                                                    <a href="#" class="badge badge-primary" data-bs-toggle="modal"
