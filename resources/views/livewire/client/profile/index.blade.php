                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_media"
                                    placeholder="Masukkan Nama Media" wire:model="detail.nama_media">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jenis_media"
                                    placeholder="Masukkan Jenis Media" wire:model="detail.jenis_media" disabled>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="whatsapp"
                                    placeholder="Masukkan No. WhatsApp" wire:model="detail.whatsapp">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" wire:model='detail.cakupan_media'
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" wire:model.live='detail.jumlah_oplah'
                                    wire:loading.attr='disabled'>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" wire:model='detail.sebaran_oplah'
                                    wire:loading.attr='disabled'>
