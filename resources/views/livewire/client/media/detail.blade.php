                            ...
                            <div class="row">
                                    ...
                                    <div class="order-left-image">
                                        ...
                                        <div class="order-image-contain">
                                            ...
                                            <h5>
                                                ...
                                                <span
                                                    x-init="startTimer('{{ Carbon::parse($mediaOrder->created_at)->addDays(7) }}','timer{{ $mediaOrder->id }}')"
                                ...
                                <div class="col-12 col-md-4">
                                    <ol class="progtrckr">
                                        @foreach($logs as $log)
                                        <li
                                            class="@if($loop->last && count($logs) > 1) progtrckr-todo @else progtrckr-done @endif">
                                            ...
                                            <p @if($loop->last && count($logs) > 1) style="margin-left:0px" @else
